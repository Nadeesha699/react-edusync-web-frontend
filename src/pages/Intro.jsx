      ...
      <div className="w-full lg:w-1/2 h-full p-10 gap-10 flex flex-col justify-between items-center lg:items-start">
        {/* <div className="flex lg:flex-row flex-col lg:justify-start justify-center items-center"> */}
          ...
          {/* <div className="flex flex-col gap-2">
            ...
            <label className="font-bold text-sm mt-1 text-center lg:text-left">
        ...
        <div className="flex flex-col gap-5 justify-center items-center lg:items-start">
          <label className="text-blue-700 text-5xl lg:text-7xl font-bold">
            &lt;Welcome/&gt;
          </label>
          ...
          <div className="flex lg:flex-row flex-col gap-5">
            <div
              className="bg-blue-700 text-white p-2 gap-2 rounded-full flex flex-row justify-center items-center font-bold duration-300 ease-in hover:bg-blue-800"
              onClick={() => {
